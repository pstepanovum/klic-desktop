...
const CUSTOM: Record<string, IconDef> = {
  ...
  search: {
    ...
    paths: [
      {
        d: "M22 22L17.7579 17.7579M17.7579 17.7579C19.4284 16.0875 20.4615 13.7798 20.4615 11.2308C20.4615 6.13276 16.3288 2 11.2308 2C6.13276 2 2 6.13276 2 11.2308C2 16.3288 6.13276 20.4615 11.2308 20.4615C13.7798 20.4615 16.0875 19.4284 17.7579 17.7579Z",
        stroke: true,
        sw: "1.5",
        cap: "round",
      },
  ...
  paperclip: {
    ...
    paths: [
      {
        d: "M14.3508 8.40754L7.4654 15.0428C6.70485 15.7757 6.70485 16.964 7.4654 17.6969C8.22594 18.4298 9.45903 18.4298 10.2196 17.6969L19.8592 8.40754C21.3803 6.94173 21.3803 4.56518 19.8592 3.09936C18.3381 1.63355 15.8719 1.63355 14.3508 3.09936L4.71122 12.3887C2.42959 14.5874 2.42959 18.1522 4.71122 20.351C6.99286 22.5497 10.6921 22.5497 12.9737 20.351L19.8592 13.7157",
        stroke: true,
        sw: "1.5",
        cap: "round",
      },
